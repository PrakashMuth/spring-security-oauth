...
public class OauthClientTokenDao extends DAOImpl<OauthClientTokenRecord, com.springsecurityoauth2.model.tables.pojos.OauthClientToken, String> {

    /**
     * Create a new OauthClientTokenDao without any configuration
     */
    public OauthClientTokenDao() {
        super(OauthClientToken.OAUTH_CLIENT_TOKEN, com.springsecurityoauth2.model.tables.pojos.OauthClientToken.class);
    }
    ...
    public OauthClientTokenDao(Configuration configuration) {
        super(OauthClientToken.OAUTH_CLIENT_TOKEN, com.springsecurityoauth2.model.tables.pojos.OauthClientToken.class, configuration);
    }

    @Override
    public String getId(com.springsecurityoauth2.model.tables.pojos.OauthClientToken object) {
     ...
     */
    public List<com.springsecurityoauth2.model.tables.pojos.OauthClientToken> fetchRangeOfTokenId(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.springsecurityoauth2.model.tables.pojos.OauthClientToken> fetchByTokenId(String... values) {
     ...
     */
    public List<com.springsecurityoauth2.model.tables.pojos.OauthClientToken> fetchRangeOfToken(byte[] lowerInclusive, byte[] upperInclusive) {
     ...
     */
    public List<com.springsecurityoauth2.model.tables.pojos.OauthClientToken> fetchByToken(byte[]... values) {
     ...
     */
    public List<com.springsecurityoauth2.model.tables.pojos.OauthClientToken> fetchRangeOfAuthenticationId(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.springsecurityoauth2.model.tables.pojos.OauthClientToken> fetchByAuthenticationId(String... values) {
     ...
     */
    public com.springsecurityoauth2.model.tables.pojos.OauthClientToken fetchOneByAuthenticationId(String value) {
     ...
     */
    public List<com.springsecurityoauth2.model.tables.pojos.OauthClientToken> fetchRangeOfUserName(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.springsecurityoauth2.model.tables.pojos.OauthClientToken> fetchByUserName(String... values) {
     ...
     */
    public List<com.springsecurityoauth2.model.tables.pojos.OauthClientToken> fetchRangeOfClientId(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.springsecurityoauth2.model.tables.pojos.OauthClientToken> fetchByClientId(String... values) {
